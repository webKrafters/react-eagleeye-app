...
const Editor = ({ setState }) => {
	...
	const updateColor = () => setState({ color: colorInputRef.current.value });
	...
	const updatePrice = () => setState({ price: Number( priceInputRef.current.value ) });
	const updateType = () => setState({ type: typeInputRef.current.value });
